...
Requirements:
- **Experience section must match resume format** with:
  - Company name: "TCS, a LeadVenture Company"
  - Job title: "Software Engineer II"
  - Dates: "January 2017 – May 2023"
  - List of 5 specific responsibilities (bullet points)
  - **Key Projects subsection** with Challenge/Solution/Impact format
- Visual timeline or card-based layout
- Education section with:
  - TripleTen Software Engineering Boot Camp (Expected January 2026)
  - Motlow State Community College - General Studies (1995)
...
```javascript
{
  ...
  responsibilities: [
    "Engineered and maintained a comprehensive desktop Point-of-Sale (POS) application...",
    "Developed and integrated custom RESTful APIs...",
    "Designed and deployed a web-based operational support dashboard using React...",
    "Architected and optimized SQL Server databases...",
    "Led Agile development workflows using Jira..."
  ],
  keyProjects: [
    {
    ...
    },
    {
      ...
      challenge: "...",
      solution: "...",
      impact: "Reduced issue identification time from potentially hours to seconds..."
    }
  ]
}
```

**Display Format for Key Projects:**
Each project should show:
- Project name (bold header)
- **Challenge:** paragraph
- **Solution:** paragraph  
- **Impact:** paragraph (highlight the metrics!)

**Commit**: `feat: implement detailed Experience and Education sections`
